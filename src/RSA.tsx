  ...
  return (
    <>
      ...
      <div>
        ...
        <span className="font-bold text-green-500 block">计算结果:</span>
        {payload && <p className="w-full overflow-visible break-words p-2">{payload}</p>}
        <span className="font-bold text-green-500">计算时间总计:</span>
        {timeCost && (<p className="w-full overflow-visible break-words p-2">{timeCost}ms</p>)}
      </div>
